...
{
	m_pCentre = renderer.CreateSprite("assets\\Sprites\\board8x8.png");
	m_pCorners[0] = renderer.CreateSprite("assets\\Sprites\\board8x8.png");
	m_pCorners[1] = renderer.CreateSprite("assets\\Sprites\\board8x8.png");
	m_pCorners[2] = renderer.CreateSprite("assets\\Sprites\\board8x8.png");
	m_pCorners[3] = renderer.CreateSprite("assets\\Sprites\\board8x8.png");
